        ...
        <Card title="Muito obrigado">
          <>
            <p>
              ...
              Forma de pagamento:{' '}
              {payWhithCard ? 'Cartão de credito' : 'Boleto Bancário'}
            </p>
            ...
            <>
              ...
              <div className="margin-top">
                {payWhithCard ? (
                  ...
                  <p>
                    Ao optar por essa forma de pagamento, importante lembrar que
                    a confirmação pode levar ate 3 dias uteis, devido aos prazos
